...
| 4 | **工程账收口**（2026-09-20 竹木定案） | 回归隔离由运行级下沉到用例级、文档口径修正、`live_2shot.cjs` 表单驱动统一到共享模块 | ▶ 进行中（14.14） | 无 |
| 5 | **P6 演示打包**（竹木选定主攻方向） | 演示形态＝**录屏成片**：多模型同镜头对比、失败恢复案例、固定样本与演示讲稿 | ⏳ 接第 4 项 | 真实生成需授权 |
